(function () {
  ...
  const translations = {
    cs: {
      ...
      'commitmentLabel': 'Závazek:',
      'modeTopology': 'Porovnání podle topologie',
      'uploadTopology': 'Nahrát topologii ve formátu json',
      'loadSample': 'Načíst vzor',
      'topologyHint': 'Nahrajte export topologie (JSON) z iaas-api-mgmt — porovná ceny VM v Business Cloudu, AWS, Azure a GCP.',
      'topologyName': (name) => name ? `Topologie: ${name}` : 'Vlastní topologie',
      'topologyNodes': (n) => `${n} VM`,
      'commitment': 'závazek',
      'businessCloud': 'Business Cloud',
      'bcModel': 'Resource Pool (Σ CPU + RAM + disk)',
      ...
      'bcPoolTitle': 'Business Cloud – IaaS Resource Pool',
      'bcPoolText': 'Cena za celou architekturu jako sdílený pool (ne per-VM). Celkem = Σ CPU GHz × sazba + Σ RAM GB × sazba + Σ disk GB × sazba tieru. CPU se účtuje za celková GHz zaokrouhlená nahoru.',
      ...
      'paasMatchingTitle': 'PaaS varianty (Elastic Beanstalk / App Engine / App Service / Business Cloud PaaS)',
      'paasMatchingText': 'VM se namapuje na nejmenší PaaS tier (1/2, 2/4, 4/8, 8/16 vCPU/RAM); Business Cloud PaaS se násobí využitím (výchozí 40 %).',
      ...
      'tcloudPrices': 'Ceny poskytnuté T-Mobile CZ (Business Cloud IaaS a PaaS ceník)',
      'notes': 'Poznámky:',
      'noteRates': 'Převodní kurzy upravíte v poli „Kurz měny“ (výchozí: 1 USD = 23 CZK, 1 USD = 0,92 EUR).',
    ...
    en: {
      ...
      'topologyHint': 'Upload a topology export (JSON) from iaas-api-mgmt — compares VM prices on Business Cloud, AWS, Azure and GCP.',
      ...
      'bcPoolTitle': 'Business Cloud – IaaS Resource Pool',
      'bcPoolText': 'Whole-architecture cost as a shared pool (not per-VM). Total = Σ CPU GHz × rate + Σ RAM GB × rate + Σ disk GB × tier rate. CPU is billed on the pooled GHz rounded up.',
      ...
      'paasMatchingTitle': 'PaaS variants (Elastic Beanstalk / App Engine / App Service / Business Cloud PaaS)',
      'paasMatchingText': 'The VM is mapped to the smallest PaaS tier (1/2, 2/4, 4/8, 8/16 vCPU/RAM); Business Cloud PaaS is scaled by utilization (default 40%).',
      ...
      'azureIaas': 'B-series VMs on-demand + managed disk (eastus)',
      'azurePaas': 'App Service Basic B1–B3 (Windows, pay-as-you-go)',
      'tcloudPrices': 'Prices provided by T-Mobile CZ (Business Cloud IaaS and PaaS price list)',
      'notes': 'Notes:',
      'noteRates': 'Exchange rates can be edited in the "Exchange rate" field (default: 1 USD = 23 CZK, 1 USD = 0.92 EUR).',
