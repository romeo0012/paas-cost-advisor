(function () {
  ...
  const translations = {
    cs: {
      ...
      'mode': 'Režim srovnání:',
      'modeTiers': 'Podle tierů',
      'modeTopology': 'Podle topologie',
      'uploadTopology': 'Topologie (JSON z iaas-api-mgmt):',
    ...
    en: {
      ...
      'mode': 'Compare mode:',
      'modeTiers': 'By tiers',
      'modeTopology': 'By topology',
      'uploadTopology': 'Topology (JSON from iaas-api-mgmt):',
