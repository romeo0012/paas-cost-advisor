(function () {
  ...
  const translations = {
    cs: {
      ...
      'notes': 'Poznámky:',
      'noteRates': 'Převodní kurzy upravíte v poli „Kurz měny“ (výchozí: 1 USD = 23 CZK, 1 EUR = 25 CZK).',
    ...
    en: {
      ...
      'notes': 'Notes:',
      'noteRates': 'Exchange rates can be edited in the "Exchange rate" field (default: 1 USD = 23 CZK, 1 EUR = 25 CZK).',
