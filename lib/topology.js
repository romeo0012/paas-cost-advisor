...
// Azure App Service, T-Cloud PaaS) from the shared tier specs + provider plans.
...
// T-Cloud PaaS is scaled by the PaaS utilization (dynamic cloudlets).
function priceTopology(topologyInput, currency = 'CZK', utilizationPct) {
